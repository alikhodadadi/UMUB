function plot_diags(x,y_matrix,y_names,xlabel_val,ylabel_val,title_val,figDir,figName,markers )
...
% legend(y_names,'interpreter','latex','Location','east', 'orientation', 'vertical'); 
