function [ t_b_pars ] = time_badge_pars_inference( data, g)
...
q_badgeWeights = rand(data.num_q_badges, 1);
...
%     c2
%     c3
    if(max([c1,c2,c3])< 0.0001 || iter > 50)
        iter
        converged = true;
    end
end
...
a_badgeWeights = rand(data.num_a_badges, 1);
